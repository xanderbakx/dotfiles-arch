'use strict'; /*jslint -W100, browser:true*/
    ...
    "appDesc_nohola": {
        "message": "Πρόσβαση μπλοκάρει ιστοσελίδες στη χώρα, την εταιρεία ή το σχολείο σας! η επέκταση αυτή είναι δωρεάν και εύκολο στη χρήση!"
    },
    "appName": {
        "message": "Απεριόριστα δωρεάν VPN - Hola"
    },
    "appName_nohola": {
